		...
		equationDrawer.setOnDrawerOpenListener(new OnDrawerOpenListener() {
			@Override
				public void onDrawerOpened() {
					...
					edParams.addRule(RelativeLayout.LEFT_OF, R.id.okButton);
					edParams.addRule(RelativeLayout.RIGHT_OF, R.id.viewButton);
					...
					viewBParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
